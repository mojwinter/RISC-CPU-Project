...
add wave -noupdate /CPU_tb/IncPC
add wave -noupdate /CPU_tb/R0in
...
add wave -noupdate /CPU_tb/R0out
...
add wave -noupdate /CPU_tb/mDataOut
...
add wave -noupdate /CPU_tb/DP/R0/clear
add wave -noupdate /CPU_tb/DP/R0/clock
add wave -noupdate /CPU_tb/DP/R0/enable
add wave -noupdate /CPU_tb/DP/R0/BAout
add wave -noupdate -radix decimal /CPU_tb/DP/R0/D
add wave -noupdate -radix decimal /CPU_tb/DP/R0/BusMuxIn
add wave -noupdate -radix decimal /CPU_tb/DP/R0/q
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_R0
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_R1
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_R2
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_R3
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_R4
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_R5
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_R6
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_R7
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_R8
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_R9
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_R10
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_R11
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_R12
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_R13
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_R14
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_R15
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_HI
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_LO
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_zHigh
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_zLow
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_PC
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_MDR
add wave -noupdate -radix decimal /CPU_tb/DP/bus/BusMuxIn_In_Port
add wave -noupdate -radix decimal /CPU_tb/DP/bus/C_sign_extended
add wave -noupdate /CPU_tb/DP/bus/R0out
add wave -noupdate /CPU_tb/DP/bus/R1out
add wave -noupdate /CPU_tb/DP/bus/R2out
add wave -noupdate /CPU_tb/DP/bus/R3out
add wave -noupdate /CPU_tb/DP/bus/R4out
add wave -noupdate /CPU_tb/DP/bus/R5out
add wave -noupdate /CPU_tb/DP/bus/R6out
add wave -noupdate /CPU_tb/DP/bus/R7out
add wave -noupdate /CPU_tb/DP/bus/R8out
add wave -noupdate /CPU_tb/DP/bus/R9out
add wave -noupdate /CPU_tb/DP/bus/R10out
add wave -noupdate /CPU_tb/DP/bus/R11out
add wave -noupdate /CPU_tb/DP/bus/R12out
add wave -noupdate /CPU_tb/DP/bus/R13out
add wave -noupdate /CPU_tb/DP/bus/R14out
add wave -noupdate /CPU_tb/DP/bus/R15out
add wave -noupdate /CPU_tb/DP/bus/HIout
add wave -noupdate /CPU_tb/DP/bus/LOout
add wave -noupdate /CPU_tb/DP/bus/Zhighout
add wave -noupdate /CPU_tb/DP/bus/Zlowout
add wave -noupdate /CPU_tb/DP/bus/PCout
add wave -noupdate /CPU_tb/DP/bus/MDRout
add wave -noupdate /CPU_tb/DP/bus/In_Portout
add wave -noupdate /CPU_tb/DP/bus/Cout
add wave -noupdate /CPU_tb/DP/bus/BusOut
add wave -noupdate /CPU_tb/DP/bus/q
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {172622 ps} 0}
...
update
WaveRestoreZoom {0 ps} {258312 ps}
