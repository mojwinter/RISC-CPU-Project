...
add wave -noupdate -radix hexadecimal -childformat {{{/CPU_tb/DP/RegIn[15]} -radix hexadecimal} {{/CPU_tb/DP/RegIn[14]} -radix hexadecimal} {{/CPU_tb/DP/RegIn[13]} -radix hexadecimal} {{/CPU_tb/DP/RegIn[12]} -radix hexadecimal} {{/CPU_tb/DP/RegIn[11]} -radix hexadecimal} {{/CPU_tb/DP/RegIn[10]} -radix hexadecimal} {{/CPU_tb/DP/RegIn[9]} -radix hexadecimal} {{/CPU_tb/DP/RegIn[8]} -radix hexadecimal} {{/CPU_tb/DP/RegIn[7]} -radix hexadecimal} {{/CPU_tb/DP/RegIn[6]} -radix hexadecimal} {{/CPU_tb/DP/RegIn[5]} -radix hexadecimal} {{/CPU_tb/DP/RegIn[4]} -radix hexadecimal} {{/CPU_tb/DP/RegIn[3]} -radix hexadecimal} {{/CPU_tb/DP/RegIn[2]} -radix hexadecimal} {{/CPU_tb/DP/RegIn[1]} -radix hexadecimal} {{/CPU_tb/DP/RegIn[0]} -radix hexadecimal}} -subitemconfig {/CPU_tb/DP/R15sig {-radix hexadecimal} /CPU_tb/DP/R14sig {-radix hexadecimal} /CPU_tb/DP/R13sig {-radix hexadecimal} /CPU_tb/DP/R12sig {-radix hexadecimal} /CPU_tb/DP/R11sig {-radix hexadecimal} /CPU_tb/DP/R10sig {-radix hexadecimal} /CPU_tb/DP/R9sig {-radix hexadecimal} /CPU_tb/DP/R8sig {-radix hexadecimal} /CPU_tb/DP/R7sig {-radix hexadecimal} /CPU_tb/DP/R6sig {-radix hexadecimal} /CPU_tb/DP/R5sig {-radix hexadecimal} /CPU_tb/DP/R4sig {-radix hexadecimal} /CPU_tb/DP/R3sig {-radix hexadecimal} /CPU_tb/DP/R2sig {-radix hexadecimal} /CPU_tb/DP/R1sig {-radix hexadecimal} /CPU_tb/DP/R0sig {-radix hexadecimal}} /CPU_tb/DP/RegIn
...
add wave -noupdate /CPU_tb/DP/Control/Gra
add wave -noupdate /CPU_tb/DP/Control/Grb
add wave -noupdate /CPU_tb/DP/Control/Grc
add wave -noupdate /CPU_tb/DP/Control/Rin
add wave -noupdate /CPU_tb/DP/Control/Rout
add wave -noupdate /CPU_tb/DP/Control/BAout
add wave -noupdate /CPU_tb/DP/Control/Cout
add wave -noupdate /CPU_tb/DP/Control/OutPort_In
add wave -noupdate /CPU_tb/DP/Control/MDRin
add wave -noupdate /CPU_tb/DP/Control/MARin
add wave -noupdate /CPU_tb/DP/Control/Zin
add wave -noupdate /CPU_tb/DP/Control/Yin
add wave -noupdate /CPU_tb/DP/Control/IRin
add wave -noupdate /CPU_tb/DP/Control/PCin
add wave -noupdate /CPU_tb/DP/Control/CONin
add wave -noupdate /CPU_tb/DP/Control/LOin
add wave -noupdate /CPU_tb/DP/Control/HIin
add wave -noupdate /CPU_tb/DP/Control/IncPC
add wave -noupdate /CPU_tb/DP/Control/PCout
add wave -noupdate /CPU_tb/DP/Control/MDRout
add wave -noupdate /CPU_tb/DP/Control/Zhighout
add wave -noupdate /CPU_tb/DP/Control/Zlowout
add wave -noupdate /CPU_tb/DP/Control/HIout
add wave -noupdate /CPU_tb/DP/Control/LOout
add wave -noupdate /CPU_tb/DP/Control/InPort_Out
add wave -noupdate /CPU_tb/DP/Control/memRead
add wave -noupdate /CPU_tb/DP/Control/ramEnable
add wave -noupdate /CPU_tb/DP/Control/ADD
add wave -noupdate /CPU_tb/DP/Control/clear
add wave -noupdate -radix hexadecimal /CPU_tb/DP/Control/IR
add wave -noupdate /CPU_tb/DP/Control/clock
add wave -noupdate /CPU_tb/DP/Control/reset
add wave -noupdate /CPU_tb/DP/Control/stop
add wave -noupdate /CPU_tb/DP/Control/Con_FF
add wave -noupdate /CPU_tb/DP/Control/present_state
add wave -noupdate -radix hexadecimal /CPU_tb/DP/CON_FF_Logic/IR
add wave -noupdate -radix hexadecimal /CPU_tb/DP/CON_FF_Logic/BusMuxOut
add wave -noupdate /CPU_tb/DP/CON_FF_Logic/CONin
add wave -noupdate /CPU_tb/DP/CON_FF_Logic/CON
add wave -noupdate /CPU_tb/DP/CON_FF_Logic/Ra
add wave -noupdate /CPU_tb/DP/CON_FF_Logic/C2
add wave -noupdate /CPU_tb/DP/CON_FF_Logic/brzr
add wave -noupdate /CPU_tb/DP/CON_FF_Logic/brnz
add wave -noupdate /CPU_tb/DP/CON_FF_Logic/brpl
add wave -noupdate /CPU_tb/DP/CON_FF_Logic/brmi
add wave -noupdate /CPU_tb/DP/CON_FF_Logic/BusOR
add wave -noupdate /CPU_tb/DP/CON_FF_Logic/bit31
add wave -noupdate /CPU_tb/DP/CON_FF_Logic/i
add wave -noupdate /CPU_tb/DP/CON_FF_Logic/D
add wave -noupdate /CPU_tb/DP/CON_FF_Logic/CONout
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {1060375 ps} 0}
...
update
WaveRestoreZoom {1030346 ps} {1296606 ps}
